...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-pirate-gold/3 rounded-full blur-[150px] pointer-events-none hidden md:block" />
      <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-pirate-bronze/5 rounded-full blur-[120px] pointer-events-none hidden md:block" />

      {/* Film Grain Overlay */}
      <div
        className="absolute inset-0 opacity-[0.03] pointer-events-none z-30 mix-blend-overlay hidden md:block"
        style={{
